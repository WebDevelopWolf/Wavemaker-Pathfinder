...
//     Connection String:      "Data Source=WEBDEVWOLF-LAPT\SQLEXPRESS;Initial Catalog=path-v1-test;Persist Security Info=True;User ID=wmsitev2;password=**zapped**;"
// ------------------------------------------------------------------------------------------------
...
namespace wm_api.Models
{
    ...
    public interface IWmDataContext : System.IDisposable
    {
        ...
        System.Data.Entity.DbSet<OrderedSessionList> OrderedSessionLists { get; set; } // OrderedSessionList
        ...
        System.Data.Entity.DbSet<Session> Sessions { get; set; } // Sessions
        System.Data.Entity.DbSet<Topic> Topics { get; set; } // Topics
        System.Data.Entity.DbSet<TopicsOverview> TopicsOverviews { get; set; } // TopicsOverview
    ...
    public class WmDataContext : System.Data.Entity.DbContext, IWmDataContext
    {
        ...
        public System.Data.Entity.DbSet<Level> Levels { get; set; } // Levels
        public System.Data.Entity.DbSet<OrderedSessionList> OrderedSessionLists { get; set; } // OrderedSessionList
        ...
        public System.Data.Entity.DbSet<Session> Sessions { get; set; } // Sessions
        public System.Data.Entity.DbSet<Topic> Topics { get; set; } // Topics
        public System.Data.Entity.DbSet<TopicsOverview> TopicsOverviews { get; set; } // TopicsOverview
        ...
        protected override void OnModelCreating(System.Data.Entity.DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new OrderedSessionListConfiguration());
            ...
            modelBuilder.Configurations.Add(new TopicsOverviewConfiguration());
        ...
        public static System.Data.Entity.DbModelBuilder CreateModel(System.Data.Entity.DbModelBuilder modelBuilder, string schema)
        {
            ...
            modelBuilder.Configurations.Add(new LevelConfiguration(schema));
            modelBuilder.Configurations.Add(new OrderedSessionListConfiguration(schema));
            ...
            modelBuilder.Configurations.Add(new TopicsOverviewConfiguration(schema));
    ...
    public class FakeWmDataContext : IWmDataContext
    {
        ...
        public System.Data.Entity.DbSet<OrderedSessionList> OrderedSessionLists { get; set; }
        ...
        public System.Data.Entity.DbSet<TopicsOverview> TopicsOverviews { get; set; }
        ...
        public FakeWmDataContext()
        {
            ...
            Levels = new FakeDbSet<Level>("LevelId");
            OrderedSessionLists = new FakeDbSet<OrderedSessionList>("SessionOrder", "LevelName", "SessionId", "TopicId");
            ...
            Topics = new FakeDbSet<Topic>("TopicId");
            TopicsOverviews = new FakeDbSet<TopicsOverview>("TopicId", "TopicTitle", "TopicDescription", "TopicVideo", "TopicCompletionTime", "TopicXpReward", "TopicRewards", "TopicBadges", "TopicPreviewImage", "TopicTag");
    ...
    public class Journey
    {
        ...
        public string JourneyRewards { get; set; } // JourneyRewards
        ...
        public string JourneyGains { get; set; } // JourneyGains
    ...
    public class Level
    {
        public System.Guid LevelId { get; set; } // LevelId (Primary key)
    ...
    // OrderedSessionList
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class OrderedSessionList
    {
        public int SessionOrder { get; set; } // SessionOrder (Primary key)
        public string SessionTitle { get; set; } // SessionTitle (length: 50)
        public string LevelName { get; set; } // LevelName (Primary key) (length: 150)
        public System.Guid SessionId { get; set; } // SessionId (Primary key)
        public System.Guid TopicId { get; set; } // TopicId (Primary key)
    }
    ...
    public class Session
    {
        public System.Guid SessionId { get; set; } // SessionId (Primary key)
        public string SessionTitle { get; set; } // SessionTitle (length: 50)
        public string SessionDescription { get; set; } // SessionDescription (length: 250)
        public string SessionVideo { get; set; } // SessionVideo (length: 100)
        public string SessionReward { get; set; } // SessionReward (length: 200)
        public string SessionCompletionTime { get; set; } // SessionCompletionTime (length: 10)
        public string SessionGains { get; set; } // SessionGains (length: 200)
        public int? SessionXpReward { get; set; } // SessionXpReward
        public System.Guid TopicId { get; set; } // TopicId
        public System.Guid LevelId { get; set; } // LevelId
        public int SessionOrder { get; set; } // SessionOrder
    ...
    {
        public System.Guid TopicId { get; set; } // TopicId (Primary key)
        public string TopicTitle { get; set; } // TopicTitle (length: 50)
        public string TopicDescription { get; set; } // TopicDescription (length: 250)
        public string TopicVideo { get; set; } // TopicVideo (length: 100)
        public string TopicRewards { get; set; } // TopicRewards
        public string TopicCompletionTime { get; set; } // TopicCompletionTime (length: 10)
        public System.Guid RelatedTopicId { get; set; } // RelatedTopicId
        public string TopicGains { get; set; } // TopicGains
        public int TopicXpReward { get; set; } // TopicXpReward
        public int TopicBadges { get; set; } // TopicBadges
        public string TopicPreviewImage { get; set; } // TopicPreviewImage (length: 250)
        public string TopicTagline { get; set; } // TopicTagline (length: 10)
        public string TopicTag { get; set; } // TopicTag (length: 150)
    ...
    {
        public System.Guid TopicId { get; set; } // TopicId (Primary key)
        public string TopicTitle { get; set; } // TopicTitle (Primary key) (length: 50)
        public string TopicDescription { get; set; } // TopicDescription (Primary key) (length: 250)
        public string TopicVideo { get; set; } // TopicVideo (Primary key) (length: 100)
        public string TopicCompletionTime { get; set; } // TopicCompletionTime (Primary key) (length: 10)
        public int TopicXpReward { get; set; } // TopicXpReward (Primary key)
        public string TopicRewards { get; set; } // TopicRewards (Primary key)
        public int TopicBadges { get; set; } // TopicBadges (Primary key)
        public string TopicPreviewImage { get; set; } // TopicPreviewImage (Primary key) (length: 250)
        public string TopicTag { get; set; } // TopicTag (Primary key) (length: 150)
    }
    ...
    {
        public System.Guid UserTopicId { get; set; } // UserTopicId (Primary key)
        public System.Guid UserId { get; set; } // UserId
        public System.Guid TopicId { get; set; } // TopicId
        public System.Guid LessonProgressId { get; set; } // LessonProgressId
    }
    ...
    public class JourneyConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Journey>
    {
        ...
        public JourneyConfiguration(string schema)
        {
            ...
            Property(x => x.JourneyRewards).HasColumnName(@"JourneyRewards").HasColumnType("varchar(max)").IsRequired().IsUnicode(false);
            ...
            Property(x => x.JourneyGains).HasColumnName(@"JourneyGains").HasColumnType("varchar(max)").IsRequired().IsUnicode(false);
    ...
    // Levels
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class LevelConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Level>
    {
        ...
        public LevelConfiguration(string schema)
        {
            ToTable("Levels", schema);
            HasKey(x => x.LevelId);

            Property(x => x.LevelId).HasColumnName(@"LevelId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.LevelName).HasColumnName(@"LevelName").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(150);
    ...
    // OrderedSessionList
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class OrderedSessionListConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<OrderedSessionList>
    {
        public OrderedSessionListConfiguration()
            : this("dbo")
        {
        }

        public OrderedSessionListConfiguration(string schema)
        {
            ToTable("OrderedSessionList", schema);
            HasKey(x => new { x.SessionOrder, x.LevelName, x.SessionId, x.TopicId });

            Property(x => x.SessionOrder).HasColumnName(@"SessionOrder").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.SessionTitle).HasColumnName(@"SessionTitle").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
            ...
            Property(x => x.SessionId).HasColumnName(@"SessionId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicId).HasColumnName(@"TopicId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
        }
    }
    ...
    public class SessionConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Session>
    {
        ...
        public SessionConfiguration(string schema)
        {
            ...
            Property(x => x.SessionId).HasColumnName(@"SessionId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.SessionTitle).HasColumnName(@"SessionTitle").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(50);
            Property(x => x.SessionDescription).HasColumnName(@"SessionDescription").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(250);
            Property(x => x.SessionVideo).HasColumnName(@"SessionVideo").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(100);
            Property(x => x.SessionReward).HasColumnName(@"SessionReward").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(200);
            Property(x => x.SessionCompletionTime).HasColumnName(@"SessionCompletionTime").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(10);
            Property(x => x.SessionGains).HasColumnName(@"SessionGains").HasColumnType("varchar").IsOptional().IsUnicode(false).HasMaxLength(200);
            Property(x => x.SessionXpReward).HasColumnName(@"SessionXpReward").HasColumnType("int").IsOptional();
            Property(x => x.TopicId).HasColumnName(@"TopicId").HasColumnType("uniqueidentifier").IsRequired();
            Property(x => x.LevelId).HasColumnName(@"LevelId").HasColumnType("uniqueidentifier").IsRequired();
            Property(x => x.SessionOrder).HasColumnName(@"SessionOrder").HasColumnType("int").IsRequired();
        }
    }

    // Topics
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class TopicConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Topic>
    {
        ...
        {
            ToTable("Topics", schema);
            HasKey(x => x.TopicId);

            Property(x => x.TopicId).HasColumnName(@"TopicId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicTitle).HasColumnName(@"TopicTitle").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(50);
            Property(x => x.TopicDescription).HasColumnName(@"TopicDescription").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(250);
            Property(x => x.TopicVideo).HasColumnName(@"TopicVideo").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(100);
            Property(x => x.TopicRewards).HasColumnName(@"TopicRewards").HasColumnType("varchar(max)").IsRequired().IsUnicode(false);
            Property(x => x.TopicCompletionTime).HasColumnName(@"TopicCompletionTime").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(10);
            Property(x => x.RelatedTopicId).HasColumnName(@"RelatedTopicId").HasColumnType("uniqueidentifier").IsRequired();
            Property(x => x.TopicGains).HasColumnName(@"TopicGains").HasColumnType("varchar(max)").IsRequired().IsUnicode(false);
            Property(x => x.TopicXpReward).HasColumnName(@"TopicXpReward").HasColumnType("int").IsRequired();
            Property(x => x.TopicBadges).HasColumnName(@"TopicBadges").HasColumnType("int").IsRequired();
            Property(x => x.TopicPreviewImage).HasColumnName(@"TopicPreviewImage").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(250);
            Property(x => x.TopicTagline).HasColumnName(@"TopicTagline").HasColumnType("nchar").IsRequired().IsFixedLength().HasMaxLength(10);
            Property(x => x.TopicTag).HasColumnName(@"TopicTag").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(150);
        }
    }

    // TopicsOverview
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class TopicsOverviewConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<TopicsOverview>
    {
        public TopicsOverviewConfiguration()
            : this("dbo")
        {
        }

        public TopicsOverviewConfiguration(string schema)
        {
            ToTable("TopicsOverview", schema);
            HasKey(x => new { x.TopicId, x.TopicTitle, x.TopicDescription, x.TopicVideo, x.TopicCompletionTime, x.TopicXpReward, x.TopicRewards, x.TopicBadges, x.TopicPreviewImage, x.TopicTag });

            Property(x => x.TopicId).HasColumnName(@"TopicId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicTitle).HasColumnName(@"TopicTitle").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(50).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicDescription).HasColumnName(@"TopicDescription").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(250).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicVideo).HasColumnName(@"TopicVideo").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(100).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicCompletionTime).HasColumnName(@"TopicCompletionTime").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(10).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicXpReward).HasColumnName(@"TopicXpReward").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicRewards).HasColumnName(@"TopicRewards").HasColumnType("varchar(max)").IsRequired().IsUnicode(false).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicBadges).HasColumnName(@"TopicBadges").HasColumnType("int").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicPreviewImage).HasColumnName(@"TopicPreviewImage").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(250).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.TopicTag).HasColumnName(@"TopicTag").HasColumnType("varchar").IsRequired().IsUnicode(false).HasMaxLength(150).HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
        }
    }
    ...
    // UsersOnJourneys
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class UsersOnJourneyConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UsersOnJourney>
    {
        public UsersOnJourneyConfiguration()
            : this("dbo")
        {
        }

        public UsersOnJourneyConfiguration(string schema)
        {
            ToTable("UsersOnJourneys", schema);
            HasKey(x => new { x.JourneyId, x.Username });
    ...
    // UsersOnTopics
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class UsersOnTopicConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UsersOnTopic>
    {
        public UsersOnTopicConfiguration()
            : this("dbo")
        {
        }

        public UsersOnTopicConfiguration(string schema)
        {
            ToTable("UsersOnTopics", schema);
            HasKey(x => new { x.TopicId, x.Username });
    ...
    // UserTopics
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.37.1.0")]
    public class UserTopicConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<UserTopic>
    {
        public UserTopicConfiguration()
            : this("dbo")
        {
        }

        public UserTopicConfiguration(string schema)
        {
            ToTable("UserTopics", schema);
            HasKey(x => x.UserTopicId);

            Property(x => x.UserTopicId).HasColumnName(@"UserTopicId").HasColumnType("uniqueidentifier").IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.None);
            Property(x => x.UserId).HasColumnName(@"UserId").HasColumnType("uniqueidentifier").IsRequired();
            Property(x => x.TopicId).HasColumnName(@"TopicId").HasColumnType("uniqueidentifier").IsRequired();
            Property(x => x.LessonProgressId).HasColumnName(@"LessonProgressId").HasColumnType("uniqueidentifier").IsRequired();
        }
